...
export default class furniture extends React.Component {
    ...
    displaydata() {
        ...
        for(let i=0;i<n;i++) {
            ReactDOM.render(<Provider store={store}><Product dataObj={this.state.dataList[i]} id={i}/></Provider>, document.getElementById('prod3'+i));
        }
    }
    ...
    displayfiltereddata(data) {
        ...
        const store = createStore(rootReducer);
        for(let i=0;i<n;i++) {
            ReactDOM.render(<Provider store={store}><Product dataObj={data[i]} id={i}/></Provider>, document.getElementById('filtprod3'+i));
        }
    }
