          ...
          <div className="row m-3">
            <div className="col-sm-6">
              ...
              <div
                ...
                onClick={() => {
                  props.history.push("/customer/dashboard/e-devices");
                }}
              >
            ...
            <div className="col-sm-6">
              ...
              <div
                className="card food"
                onClick={() => {
                  props.history.push("/customer/dashboard/food");
                }}
              >
                <div className="card-body">
          ...
          <div className="row m-3">
            <div className="col-sm-6">
              ...
              <div
                ...
                onClick={() => {
                  props.history.push("/customer/dashboard/furniture");
                }}
              >
                <div className="card-body">
            ...
            <div className="col-sm-6">
              ...
              <div
                ...
                onClick={() => {
                  props.history.push("/customer/dashboard/clothes");
                }}
              >
                <div className="card-body">
